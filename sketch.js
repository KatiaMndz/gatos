...
function preload(){  
  ...
  arrowImage = loadImage("flame.png");
  bowImage = loadImage("dragonzon.png");
  red_balloonImage = loadImage("gatoarcoiris.png");
  green_balloonImage = loadImage("gatoverde.png");
  pink_balloonImage = loadImage("gatorosa.png");
  blue_balloonImage = loadImage("gatoamarillo.png");
}
